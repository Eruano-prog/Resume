...
\newcommand{\educationEntry}[5]{
  ...
  \item
      ...
      \textbf{#1} \\
      \vspace{-4pt}\if\relax\detokenize{#2}\relax \else \textit{\textbf{#2}} & \textcolor{mygray}{\textit{\small #5}}  \\ \fi 
      \if\relax\detokenize{#3}\relax \else {\small#3} \\ \fi 
      \if\relax\detokenize{#4}\relax \else \parbox[t]{0.8\textwidth}{\small#4} \\ \fi 
    \end{tabular*}
}
...
\section{Проекты}
  \resumeSubHeadingListStart
      ...
      {Text1}{Text2}{Микросервисное приложение на Go}{Text4}
