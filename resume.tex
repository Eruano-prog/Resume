...
\section{Образование}
  \resumeSubHeadingListStart
    ...
    {}{}
      {{ Университет ИТМО }}{
      \vspace{5pt}
      \newline{\textbf{Факультет Информационных технологий и программирования:} }
      \newline{\textbf{Программа:} \href{https://abit.itmo.ru/program/bachelor/software_engineering}{ Разработка Программного Обеспечения/Software Engeneering\ExternalLink}}
      \newline{\textbf{Пройденные курсы:} Операционные системы, Алгоритмы и Структуры данных, Объектно-ориентированное проектирование, Технологии программирования на Java, Базы данных}
      }
    \resumeSubHeadingListEnd
...
\section{Проекты}
  \resumeSubHeadingListStart
      ...
      {}{}{\href{https://github.com/Eruano-prog/JTechLab/tree/main/Microservices}{ Приложение с микросервисной работой на Java\ExternalLink}}{}
      {\skill{Java} \skill{Spring} \skill{Kafka} \skill{PostgreSQL}}
          \resumeDesc{
          \begin{itemize}
