...
\section{Образование}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Курс по языку Go}
      {}
      {\skill{Go} \skill{Concurrency} \skill{Базы данных} \skill{Тестирование}}
    
    \resumeDesc{
      \begin{itemize}
        \item Темы курса: Горутины и каналы, продвинутое тестирование, concurrency with shared memory
        \item Работа с базами данных, reflection, Go tooling
      \end{itemize}
    }
    ...
    \resumeSubheading
      ...
      {}
      {\skill{Go} \skill{gRPC} \skill{REST} \skill{Микросервисы} \skill{Тестирование}}
    
    \resumeDesc{
      \begin{itemize}
        \item Темы курса: Rest, gRPC, распределение нагрузки, микросервисная архитектура
        \item Продвинутые техники тестирования распределенных систем
      \end{itemize}
    }
