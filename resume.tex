...
\section{О себе}
\justifying
Студент третьего курса. Ищу работу в компании, которая даст возможность получить опыт комерческой раработки бэкенд приложений. В данный момент готов рассмотреть график с возможностью совмещать работу с учёбой
...
\section{Образование}
  \resumeSubHeadingListStart
    \resumeSubheading
    {}{}
      {{ Университет ИТМО}} {3-й курс\vspace{7pt}} \break
      {
    ...
    \resumeSubheading
    {}{}
      {{ Яндекс ШАД }} {Осень 2024\vspace{7pt}} \break
      {
          \textbf{Программа:} Язык Go \par
